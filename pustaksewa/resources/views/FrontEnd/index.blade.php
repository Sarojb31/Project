            ...
            <div class="carousel-item active">
              ...
              <div class="col-sm-6 col-md-3 col- " >
                <figure class="card card-product "  >
                    <div class="img-wrap "> <a href="#"><img src="{{asset('public/FrontEnd_asset/images/pd-2.jpg')}}"></a></div>
                ...
                <figure class="card card-product "  >
                    <div class="img-wrap "> <a href="product1.html"><img src="{{asset('public/FrontEnd_asset/images/pd-2.jpg')}}"></a></div>
                    <figcaption class="info-wrap">
                        <a href="product1.html" class="title">Everything is Fucked</a>
                        <p>A story about how to enjoy life in your life</p>
                          <div class="price-wrap">
        ...
        <div class="carousel-item">
            <div class="row">
              <div class="col-sm-6 col-md-3" >
                ...
                <div class="col-sm-6 col-md-3" >
                <figure class="card card-product "  >
                    <div class="img-wrap "><a href="product1.html"></a> <img src="{{asset('public/FrontEnd_asset/images/pd-2.jpg')}}"></a></div>
                    <figcaption class="info-wrap">
                        <a href="product1.html" class="title">Everything is Fucked</a>
                        <p>A story about how to enjoy life in your life</p>
                          <div class="price-wrap">
                ...
                <div class="col-sm-6 col-md-3" >
                <figure class="card card-product "  >
                    <div class="img-wrap "> <img src="{{asset('public/FrontEnd_asset/images/pd-2.jpg')}}"></div>
                    <figcaption class="info-wrap">
                        <a href="product1.html" class="title">Everything is Fucked</a>
                        <p>A story about how to enjoy life in your life</p>
                          <div class="price-wrap">
